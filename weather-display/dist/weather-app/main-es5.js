...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppForecastForecastComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ForecastComponent_ng_container_0_div_9_ng_container_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    ForecastComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], [1, "card"], [1, "card-body"], [1, "card-subtitle"], [1, "container"], ["class", "text-center ", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "text-center", 3, "ngClass"], [1, "header"], ["id", "icon"], [1, "content"], [3, "ngClass"], [1, "item", "pair"], ["id", "degree", 1, "wi", "wi-fahrenheit"], [1, "item"], [1, "wi", "wi-sunrise"], [1, "wi", "wi-sunset"], [1, "pair"], [1, "wi", "wi-strong-wind"], [1, "wi", "wi-humidity"], [1, "wi", 3, "ngClass"]],
